...
class Nav(QWidget):
    def __init__(self):
        ...
        self.topnav_group.setStyleSheet("background:{};border-radius:0px;".format(static.data["topnav"]["bg"]))
...
class miniQlabel(QLabel):
    def __init__(self,arg):
        super().__init__()
        self.setText(arg)
        self.setStyleSheet("color:{};font-size:14px;".format(static.data["to_btn"]["color"]))
        self.setFixedSize(static.data["to_btn"]["width"],static.data["to_btn"]["height"])
        self.setAlignment(Qt.AlignmentFlag.AlignCenter)
        
    def enterEvent(self, event):
        self.setStyleSheet("font-size:14px;color:{};background-color: {};border-radius:4px;".format(static.data["to_btn"]["focuscolor"],static.data["to_btn"]["focusbackground"]))
    
    def leaveEvent(self, event):
        self.setStyleSheet("font-size:14px;color:{};background-color: {};border-radius:4px;".format(static.data["to_btn"]["color"],static.data["to_btn"]["nobackground"]))
